...
class CLI:
    ...
    def run(self):
        ...
        server_parser.add_argument('--port', type=int, default=8082, help='Server port')
...
python xsl.py list --xpath "//svg:*"
python xsl.py query "//svg:text[@id='text1']"
...
# Edit elements
python xsl.py set "//svg:text[@id='text1']" "Modified Text"
...
# Start server
python xsl.py server --port 8082
...
curl "http://localhost:8082/api/extract?url=http://example.com/file.svg&xpath=//svg:image/@xlink:href"
...
'''
        ...
        print("Use 'python xsl.py examples --help' to see usage examples")
